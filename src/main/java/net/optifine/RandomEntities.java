...
public class RandomEntities
{
    ...
    {
        WorldChangeEvent worldChangeEvent = new WorldChangeEvent(oldWorld, newWorld);
        EventManager.call(worldChangeEvent);
        if (worldChangeEvent.isCancelled() || newWorld == null) {
            return;
        }

        // Iterate over each entity in the new world and perform some action
