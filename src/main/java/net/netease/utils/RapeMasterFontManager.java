...
public class RapeMasterFontManager {
    ...
    public void drawStringDynamic(String text, double x2, double y2) {
        GradientUtil.applyGradientHorizontal((float)x2, (float)y2, this.getStringWidth(text), this.getFontHeight(), 1.0f, HUD.color1.getColor(), HUD.color2.getColor(), () -> {
    ...
    private int generateCharTexture(int id) {
        ...
        GL11.glTexImage2D(3553, 0, 6408, this.textureWidth, this.textureHeight, 0, 6408, 5121, RapeMasterFontManager.imageToBuffer(img));
        return textureId;
    }
