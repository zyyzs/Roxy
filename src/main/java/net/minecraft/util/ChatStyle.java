...
public class ChatStyle
{
    ...
    /**
     * The effective chat click events.
     */
    public ClickEvent getChatClickEvent()
    {
    ...
    /**
     * The effective chat hover events.
     */
    public HoverEvent getChatHoverEvent()
    {
    ...
    /**
     * Sets the events that should be run when text of this ChatStyle is clicked on.
     */
    public ChatStyle setChatClickEvent(ClickEvent event)
    {
    ...
    /**
     * Sets the events that should be run when text of this ChatStyle is hovered over.
     */
    public ChatStyle setChatHoverEvent(HoverEvent event)
    {
