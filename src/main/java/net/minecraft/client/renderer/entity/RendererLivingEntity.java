...
//import lol.tgformat.module.impl.render.MoBendsMod;
import lol.tgformat.module.impl.render.ChamsESP;
import lol.tgformat.module.impl.render.ESPChams;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        MoBends moBends = ModuleManager.getModule(MoBends.class);
