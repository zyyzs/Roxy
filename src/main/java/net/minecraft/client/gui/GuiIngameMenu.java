    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 1:
                ...
                if (flag)
                {
                    this.mc.displayGuiScreen(Client.instance.getMainMenu());
                }
                else if (flag1)
                {
                    RealmsBridge realmsbridge = new RealmsBridge();
                    realmsbridge.switchToRealms(Client.instance.getMainMenu());
                }
                else
                {
                    this.mc.displayGuiScreen(new GuiMultiplayer(Client.instance.getMainMenu()));
                }
