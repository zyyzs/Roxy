...
//        this.drawSplashScreen(this.renderEngine);
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = Client.instance.getMainMenu();
        }
        ...
        if (guiScreenIn instanceof GuiMainMenu || guiScreenIn instanceof MainMenu)// || guiScreenIn instanceof MainM
        {
        ...
        if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem())
        {
            if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air && this.playerController.onPlayerDamageBlock(blockpos, this.objectMouseOver.sideHit))
                {
                    ...
                    EventManager.call(new ClickBlockEvent(this.objectMouseOver.getBlockPos(), this.objectMouseOver.sideHit));
