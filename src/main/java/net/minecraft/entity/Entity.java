...
public abstract class Entity implements ICommandSender
{
    ...
    /**
     * The distance that has to be exceeded in order to triger a new step sound and an onEntityWalking events on a block
     */
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        ...
        if (player) {
            StrafeEvent event = new StrafeEvent(forward, strafe, friction, rotationYaw);
    ...
    public Vec3 getSeverPosition() {
        return new Vec3(realPosX, realPosY, realPosZ);
    }
}
