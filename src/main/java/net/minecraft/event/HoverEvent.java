...
public class HoverEvent
{
    ...
    /**
     * Gets the action to perform when this events is raised.
     */
    ...
    /**
     * Gets the value to perform the action on when this events is raised.  For example, if the action is "show item",
