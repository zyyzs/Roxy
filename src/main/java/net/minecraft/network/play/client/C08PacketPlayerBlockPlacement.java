...
public class C08PacketPlayerBlockPlacement implements Packet<INetHandlerPlayServer>
{
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        this.facingX = buf.readUnsignedByte() / PacketFixer.fixRightClick();
        this.facingY = buf.readUnsignedByte() / PacketFixer.fixRightClick();
        this.facingZ = buf.readUnsignedByte() / PacketFixer.fixRightClick();
    }
