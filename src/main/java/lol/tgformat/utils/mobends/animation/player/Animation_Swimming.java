package lol.tgformat.utils.mobends.animation.player;
...
import lol.tgformat.utils.mobends.util.GUtil;
...
public class Animation_Swimming extends Animation {
    ...
    public void animate(EntityLivingBase argEntity, ModelBase argModel, EntityData argData) {
        ...
        if (data.motion.x == 0 & data.motion.z == 0) {
            ...
            model.bipedLeftForeArm.rotation.setSmoothX(armSway2 * -40, 0.3f);
            model.bipedRightForeArm.rotation.setSmoothX(armSway2 * -40, 0.3f);
            ...
            model.bipedLeftForeLeg.rotation.setSmoothX(5, 0.4f);
            model.bipedRightForeLeg.rotation.setSmoothX(5, 0.4f);
            ...
            model.bipedLeftForeArm.rotation.setSmoothX((foreArmSway < 0.55f | foreArmSway > 0.9) ? foreArmStretch * -60.0f : -60, 0.3f);
            model.bipedRightForeArm.rotation.setSmoothX((foreArmSway < 0.55f | foreArmSway > 0.9) ? foreArmStretch * -60.0f : -60, 0.3f);
