package lol.tgformat.utils.mobends.client.renderer.entity;
...
import lol.tgformat.utils.mobends.client.renderer.entity.layers.LayerBendsCape;
import lol.tgformat.utils.mobends.client.renderer.entity.layers.LayerBendsCustomHead;
import lol.tgformat.utils.mobends.client.renderer.entity.layers.LayerBendsPlayerArmor;
...
public class RenderBendsPlayer extends RenderPlayer {
    ...
    protected void preRenderCallback(AbstractClientPlayer p_77041_1_, float p_77041_2_) {
        ...
        Data_Player data = (Data_Player) Data_Player.get(p_77041_1_.getEntityId());

        if (ModuleManager.getModule(MoBends.class).swordTrail.isEnabled()) {
            GL11.glPushMatrix();
            float f5 = 0.0625F;
