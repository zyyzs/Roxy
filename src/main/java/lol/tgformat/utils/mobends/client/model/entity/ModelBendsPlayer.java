package lol.tgformat.utils.mobends.client.model.entity;

import lol.tgformat.utils.mobends.AnimatedEntity;
import lol.tgformat.utils.mobends.client.model.ModelBoxBends;
import lol.tgformat.utils.mobends.client.model.ModelRendererBends;
import lol.tgformat.utils.mobends.client.model.ModelRendererBends_SeperatedChild;
import lol.tgformat.utils.mobends.client.renderer.SwordTrail;
import lol.tgformat.utils.mobends.data.Data_Player;
import lol.tgformat.utils.mobends.pack.BendsPack;
import lol.tgformat.utils.mobends.pack.BendsVar;
...
public class ModelBendsPlayer extends ModelPlayer {
    ...
    public void setRotationAngles(float argSwingTime, float argSwingAmount, float argArmSway, float argHeadY, float argHeadX, float argNr6, Entity argEntity) {
        ...
        ((Data_Player) Data_Player.get(argEntity.getEntityId())).syncModelInfo(this);
    }
    ...
    public void updateWithEntityData(AbstractClientPlayer argPlayer) {
        Data_Player data = (Data_Player) Data_Player.get(argPlayer.getEntityId());
        if (data != null) {
            this.renderOffset.set(data.renderOffset);
            this.renderRotation.set(data.renderRotation);
            this.renderItemRotation.set(data.renderItemRotation);
