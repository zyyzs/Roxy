...
public class SettingsPanel extends Panel {
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        Pair<Color, Color> colors = Pair.of(Color.CYAN);
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            boolean isHoveringSetting = RenderUtil.isHovering(x + 5, settingY, 130, settingHeight - 2, mouseX, mouseY);
                ...
                for (String mode : modeSetting.modes) {
                    if (!mode.equalsIgnoreCase(modeSetting.getMode())) {
                        ...
                        boolean isHoveringMode = animation.getDirection().equals(Direction.FORWARDS) &&
                                RenderUtil.isHovering(x + 115 - stringWidth, settingY + (modeCount * 15), modeWidth, 11, mouseX, mouseY);
            ...
            if (setting instanceof ColorSetting) {
                ...
                if (button == 0 && type == GuiEvents.CLICK) {
                    if (RenderUtil.isHovering(gradientX, gradientY + gradientHeight + 3, (gradientWidth + 10), 6, mouseX, mouseY)) {
                ...
                boolean hoveringRound = RenderUtil.isHovering(textX, textY, tenacityFont14.getStringWidth(text) + 4, tenacityFont14.getHeight() + 2, mouseX, mouseY);
                ...
                if (colorSetting.isRainbow()) {
                    ...
                    boolean hoveringSat = RenderUtil.isHovering(gradientX, textY + 10, gradientWidth + 10, 6, mouseX, mouseY);
            ...
            if (setting instanceof MultipleBoolSetting) {
                ...
                for (BooleanSetting booleanSetting : multiBoolSetting.getBoolSettings()) {
                    ...
                    boolean isHoveringBool = animation.getDirection().equals(Direction.FORWARDS) &&
                            RenderUtil.isHovering(x + 17, settingY + (boolCount * 15),
