...
public class SideGUIHotbar implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        tenacityFont18.drawString(Client.instance.getVersion(), x + 9.5f + tenacityBoldFont32.getStringWidth("Tenacity") - 2,
        ...
        if (!searchAnimation.isDone() || searchAnimation.finished(Direction.FORWARDS)) {
            ...
            searchType.setAccentColor(ColorUtil.applyOpacity(Color.CYAN, searchType.getAlpha()));
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (refreshTimer.hasTimeElapsed(12000)) {
