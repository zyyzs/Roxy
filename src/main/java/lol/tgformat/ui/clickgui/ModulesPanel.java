...
public class ModulesPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (!(RenderUtil.isHovering(x + (250 + (55 * expandAnim.getOutput().floatValue())), y, 135, 250, mouseX, mouseY) && currentlySelected != null)) {
            scroll.onScroll(25);
        }
        ...
        if (currentlySelected != null) {
            if (RenderUtil.isHovering(x + (float) (305), y, 135, 250, mouseX, mouseY)) {
            ...
            lol.tgformat.ui.utils.RenderUtil.scissor(newX, y + .5f, 135, 255);
