...
import lol.tgformat.ui.font.StringUtils;
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            if (setting instanceof NumberSetting) {
                ...
                boolean hoveringSlider = RenderUtil.isHovering(sliderX, sliderY - 2, sliderWidth, sliderHeight + 4, mouseX, mouseY);
                ...
                numberSettingMap.put(numberSetting, (float) lol.tgformat.ui.utils.RenderUtil.animate(sliderWidth * sliderMath, numberSettingMap.get(numberSetting), .1));
            ...
            if (setting instanceof BooleanSetting) {
                ...
                boolean hoveringBool = RenderUtil.isHovering(boolX - 2, boolY - 2, boolWH + 4, boolWH + 4, mouseX, mouseY);
            ...
            if (setting instanceof ColorSetting) {
                ...
                boolean hovered = RenderUtil.isHovering(x + rectWidth - (colorWidth + 5), middleSettingY - 1, colorWidth, 6, mouseX, mouseY);
                ...
                if (clickAnimation.isDone() && clickAnimation.getDirection().equals(Direction.FORWARDS) || !clickAnimation.isDone()) {
                    ...
                    if (type == GuiEvents.CLICK) {
                        if (button == 0) {
                            if (RenderUtil.isHovering(gradientX + gradientWidth + 5, gradientY, 5, gradientHeight, mouseX, mouseY)) {
                                draggingNumber = setting;
                                hueFlag = true;
                            }
                            if (RenderUtil.isHovering(gradientX, gradientY, gradientWidth, gradientHeight, mouseX, mouseY)) {
                                draggingNumber = setting;
                                hueFlag = false;
                            }
                        }
                    ...
                    if (type == GuiEvents.CLICK && button == 0) {
                        if (RenderUtil.isHovering(rainbowX + tenacityFont14.getStringWidth("Rainbow: ") + 3,
                    ...
                    if (colorSetting.isRainbow()) {
                        ...
                        boolean hoveringSat = RenderUtil.isHovering(gradientX + gradientWidth + 15, gradientY, 5, gradientHeight, mouseX, mouseY);
            ...
            if (setting instanceof ModeSetting) {
                ...
                boolean hovered = RenderUtil.isHovering(x + rectWidth - (modeRectWidth + 5), realY, modeRectWidth, modeSize, mouseX, mouseY);
                ...
                if (!openAnimation.isDone() || openAnimation.getDirection().equals(Direction.FORWARDS)) {
                    ...
                    for (String mode : modeSetting.modes) {
                        ...
                        boolean hoveringMode = RenderUtil.isHovering(x + rectWidth - (modeRectWidth + 5),
                ...
                lol.tgformat.ui.utils.RenderUtil.drawClickGuiArrow(x + rectWidth - 11, realY + modeSize / 2f - 1, 4, openAnimation, -1);
            ...
            if (setting instanceof MultipleBoolSetting) {
                ...
                if (!openingAnimation.isDone() || openingAnimation.getDirection().equals(Direction.FORWARDS)) {
                    ...
                    for (BooleanSetting booleanSetting : booleanSettings) {
                        ...
                        boolean hovered = RenderUtil.isHovering(x + rectWidth - (width + 5),
                ...
                boolean hovering = RenderUtil.isHovering(x + rectWidth - (width + 5), realY, width, boolRectSize, mouseX, mouseY);

                if (hovering && button == 1 && type == GuiEvents.CLICK) {
                    openingAnimation.changeDirection();
                }

                lol.tgformat.ui.utils.RenderUtil.drawClickGuiArrow(x + rectWidth - 11, realY + boolRectSize / 2f - 1, 4, openingAnimation, -1);
