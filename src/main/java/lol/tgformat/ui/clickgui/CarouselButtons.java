...
public class CarouselButtons implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        hovering = RenderUtil.isHovering(x, y, buttonWidth, rectHeight, mouseX, mouseY);
        ...
        Color accentColor = ColorUtil.applyOpacity(Color.CYAN, getAlpha());
