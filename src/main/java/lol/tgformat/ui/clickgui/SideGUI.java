...
public class SideGUI implements Screen {
    ...
    private HashMap<String, lol.tgformat.ui.panel.Panel> panels;
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (panels.containsKey(hotbar.getCurrentPanel())) {
            lol.tgformat.ui.panel.Panel panel = panels.get(hotbar.getCurrentPanel());
    ...
    public static boolean isHovering(float x, float y, float width, float height, int mouseX, int mouseY) {
        return currentForm == null && net.netease.utils.RenderUtil.isHovering(x, y, width, height, mouseX, mouseY);
    }
