...
import lol.tgformat.api.event.events.EventStoppable;
...
public final class EventManager {
    ...
    private static void register(Method method, Object object) {
        ...
        final MethodData data = new MethodData(object, method, method.getAnnotation(Listener.class).value());
        ...
        if (REGISTRY_MAP.containsKey(indexClass)) {
            ...
            REGISTRY_MAP.put((Class<? extends Event>) indexClass, (List<MethodData>)new CopyOnWriteArrayList<MethodData>(){
